...
if __name__ == '__main__':
    ...
    if args.train_and_get_confounder:
        ...
        num_patients = 500 # You can modify the location number
        max_timesteps = 3650 # Max time steps
        ...
        print(f"Combined data save to {output_file_combined}")
        print(f"Source1 data save to {output_file_source1}")
        print(f"Source2 data save to {output_file_source2}")
        ###################################################################################################
        ###################################################################################################
        ###################################################################################################
