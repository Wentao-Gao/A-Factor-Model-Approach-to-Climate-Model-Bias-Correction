...
if __name__ == '__main__':
    ...
    parser.add_argument('--target', type=str, default='prate', help='target feature in S or MS task')
    ...
    parser.add_argument('--c_out', type=int, default=55, help='output size') # applicable on arbitrary number of variates in inverted Transformers
